...
import (
	...
	b3loader "battleservice/src/services/base/behavior3go/loader"
	"fmt"
	"io/ioutil"
...
func LoadSkillBevTree() bool {
	seelog.Info("load skill tree...", b3.VERSION)
	...
	seelog.Info("load gethit tree...", b3.VERSION)
...
func createBevTree(skillid uint32, prefix string) *b3core.BehaviorTree {
	...
	seelog.Infof("create %s tree: %s", prefix, path)
