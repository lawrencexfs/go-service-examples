...
func (this *Tick) _enterNode(node IBaseNode) {
	...
	//seelog.Info("_enterNode:", this.debug, " id:", node.GetID(), " ", node.GetTitle())
...
func (this *Tick) _tickNode(node IBaseNode) {
	// TODO: call debug here
	//seelog.Info("_tickNode:", this.debug, " id:", node.GetID(), " ", node.GetTitle(), " count:", this._nodeCount)
}
...
func (this *Tick) _closeNode(node IBaseNode) {
	// TODO: call debug here
	//seelog.Info("_closeNode:", this.debug, " id:", node.GetID(), " ", node.GetTitle())
